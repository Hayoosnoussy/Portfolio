...
class DefaultController extends AbstractController
{
 ...
 function home ()
 {
    ...
    /**
     * @Route("/lfdetails" , name="archivedetails")
     */
    ...
    /**
     * @Route("/profil/{username}ID{id}/edit", name="app_edit" , methods={"GET","POST"})
     */
    ...
    /*
    /**
     * @Route("/profil/{id}/edit", name="app_edit" , methods={"GET","POST"}) fel x zeda badel el nom b id
     */
    /*
    public function profiledit(Request $request, Personne $personne,UserPasswordEncoderInterface $encoder): Response
    {
