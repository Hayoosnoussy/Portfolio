...
//ta njiwha hedhi
    ...
    /**
     * @Route("/personne/new", name="personne_new", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/personne/{id}", name="personne_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/personne/{id}/edit", name="personne_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/personne/{id}", name="personne_delete", methods={"POST"})
     */
