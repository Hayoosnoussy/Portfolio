...
public class TinyDB {
    ...
    public ArrayList<InstrumentDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<InstrumentDomain> playerList =  new ArrayList<InstrumentDomain>();

        for(String jObjString : objStrings){
            InstrumentDomain player  = gson.fromJson(jObjString,  InstrumentDomain.class);
    ...
    public void putListObject(String key, ArrayList<InstrumentDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(InstrumentDomain player: playerList){
