...
public class Article {
    ...
    public Article(int id_user, int id, int id_categ, Timestamp date_article, String title, String contenu, int nbrlike, int nbrvu, int nbrcomment) {
        this.id_user = id_user;
        this.id = id;
        this.id_categ = id_categ;
    ...
    public String toString() {
        return "Article{" + "id_user=" + id_user + ", id=" + id + ", id_categ=" + id_categ + ", date_article=" + date_article + ", title=" + title + ", nbrdislike=" + nbrdislike + ", contenu=" + contenu + ", nbrlike=" + nbrlike + ", nbrvu=" + nbrvu + ", nbrcomment=" + nbrcomment + '}';
    }
