...
public class Paie_Prof {
    ...
    public Paie_Prof(int num_paiment, String cin, float nbre_heure, float salaire_heure, double montant, String mode_reg, Date date) {
    ...
    public Paie_Prof(String cin, float nbre_heure, float salaire_heure, double montant, String mode_reg, String nom, String prenom, Date date,String email) {
        this.cin = cin;
        this.nbre_heure = nbre_heure;
        this.salaire_heure = salaire_heure;
        this.montant = montant;
    ...
    public String toString() {
        return "Paie_Prof{" + "num_paiment=" + num_paiment + ", cin=" + cin + ", nbre_heure=" + nbre_heure + ", salaire_heure=" + salaire_heure + ", montant=" + montant + ", mode_reg=" + mode_reg + ", date=" + date + '}';
    }
