...
public class OrderItemProcessor implements ItemProcessor<Invitation, Invitation> {
	...
	public Invitation process(Invitation Invitation) throws Exception {
		...
		try {
			emailService.sendSimpleMessage(Invitation.getDestinataireEmail(), "Invitation  ",
					"Bonjour " + "Rejoindre notre plateform pour rendre vos voyage de travail plus facile "+ " "  +"http://localhost:8082/GlobeBusiness/employee/add-employee");
