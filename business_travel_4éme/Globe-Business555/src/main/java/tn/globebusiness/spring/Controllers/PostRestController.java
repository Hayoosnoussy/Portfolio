...
public class PostRestController {
	...
	public Comment addComment(@RequestParam("idEmployee") Long idEmployee, @RequestParam("idPost") Long idPost,
	...
	public Comment updateComment(@RequestParam("idComment") Long idComment, @RequestParam("idEmployee") Long idEmployee,
			@RequestBody Comment comm) {
		return ips.updateComment(idComment, idEmployee, comm);
	}

	@PostMapping("sharePost")
	public Share sharePost(@RequestParam("idEmployee1") Long idEmployee1, @RequestParam("idEmployee2") Long idEmployee2,
