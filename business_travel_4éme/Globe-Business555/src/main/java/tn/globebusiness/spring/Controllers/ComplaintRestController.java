...
public class ComplaintRestController {
	...
	public Complaint addComplaint(@RequestBody Complaint complaint, @RequestParam("idEmployee") Long idEmployee,
	...
	public String traiterReclamation(@RequestParam("idReclamation") Long idReclamation,
			@RequestBody NotifComplaint nf) {
