...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\ApiPatientController' => 'getApiPatientControllerService',
            'App\\Controller\\AuthController' => 'getAuthControllerService',
            'App\\Controller\\OrdonanceController' => 'getOrdonanceControllerService',
    ...
    {
        $a = new \Twig\Loader\FilesystemLoader([], 'E:\\cabinet');
        $a->addPath('E:\\cabinet\\vendor\\symfony\\web-profiler-bundle/Resources/views', 'WebProfiler');
        $a->addPath('E:\\cabinet\\vendor\\symfony\\web-profiler-bundle/Resources/views', '!WebProfiler');
        $a->addPath('E:\\cabinet\\vendor\\symfony\\debug-bundle/Resources/views', 'Debug');
        $a->addPath('E:\\cabinet\\vendor\\symfony\\debug-bundle/Resources/views', '!Debug');
        $a->addPath('E:\\cabinet\\vendor\\doctrine\\doctrine-bundle/Resources/views', 'Doctrine');
        $a->addPath('E:\\cabinet\\vendor\\doctrine\\doctrine-bundle/Resources/views', '!Doctrine');
        $a->addPath('E:\\cabinet\\vendor\\doctrine\\doctrine-migrations-bundle/Resources/views', 'DoctrineMigrations');
        $a->addPath('E:\\cabinet\\vendor\\doctrine\\doctrine-migrations-bundle/Resources/views', '!DoctrineMigrations');
        $a->addPath('E:\\cabinet\\vendor\\symfony\\security-bundle/Resources/views', 'Security');
        $a->addPath('E:\\cabinet\\vendor\\symfony\\security-bundle/Resources/views', '!Security');
        $a->addPath('E:\\cabinet\\vendor\\api-platform\\core\\src\\Bridge\\Symfony\\Bundle/Resources/views', 'ApiPlatform');
        $a->addPath('E:\\cabinet\\vendor\\api-platform\\core\\src\\Bridge\\Symfony\\Bundle/Resources/views', '!ApiPlatform');
        $a->addPath('E:\\cabinet/templates');
        $a->addPath('E:\\cabinet\\vendor\\symfony\\twig-bridge/Resources/views/Email', 'email');
        $a->addPath('E:\\cabinet\\vendor\\symfony\\twig-bridge/Resources/views/Email', '!email');
        $a->addPath('E:\\cabinet\\vendor\\symfony\\twig-bridge/Resources/views/Form');
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension($f, 'E:\\cabinet', 'UTF-8'));
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('uRJS8p2-Qv', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ZkJh6sDRUI', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('45ngw5uz38', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\CompteurRepository' => ['privates', 'App\\Repository\\CompteurRepository', 'getCompteurRepositoryService', true],
            ...
            'App\\Repository\\MedicamentRepository' => ['privates', 'App\\Repository\\MedicamentRepository', 'getMedicamentRepositoryService', true],
            'App\\Repository\\ModeregRepository' => ['privates', 'App\\Repository\\ModeregRepository', 'getModeregRepositoryService', true],
            'App\\Repository\\NationaliteRepository' => ['privates', 'App\\Repository\\NationaliteRepository', 'getNationaliteRepositoryService', true],
            'App\\Repository\\OrdonanceRepository' => ['privates', 'App\\Repository\\OrdonanceRepository', 'getOrdonanceRepositoryService', true],
            ...
            'App\\Repository\\ReglementRepository' => ['privates', 'App\\Repository\\ReglementRepository', 'getReglementRepositoryService', true],
            ...
            'App\\Repository\\ModeregRepository' => '?',
            'App\\Repository\\NationaliteRepository' => '?',
            'App\\Repository\\OrdonanceRepository' => '?',
            'App\\Repository\\PatientRepository' => '?',
            'App\\Repository\\RdvRepository' => '?',
            'App\\Repository\\ReglementRepository' => '?',
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('srnMpfKBBx', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('m9U1mbO0iG', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fbu6THRHLq', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('BP-2XWzUKr', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('KuoUHaZdUW', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2DdtcdImRX', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('AxkD72R1j4', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7otpqHu57p', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('T1uD3JZ6jC', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['debug.file_link_formatter'] = new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter(NULL, ($this->services['request_stack'] ?? ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), 'E:\\cabinet', function () {
    ...
    protected function getDoctrine_Migrations_DependencyFactoryService()
    {
        ...
        $a->addMigrationsDirectory('DoctrineMigrations', 'E:\\cabinet/migrations');
    ...
    {
        return $this->privates['doctrine.orm.default_annotation_metadata_driver'] = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(($this->privates['annotations.cached_reader'] ?? $this->getAnnotations_CachedReaderService()), [0 => 'E:\\cabinet\\src\\Entity']);
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        ]), new \Symfony\Component\Translation\Formatter\MessageFormatter(new \Symfony\Component\Translation\IdentityTranslator()), 'en', ['translation.loader.php' => [0 => 'php'], 'translation.loader.yml' => [0 => 'yaml', 1 => 'yml'], 'translation.loader.xliff' => [0 => 'xlf', 1 => 'xliff'], 'translation.loader.po' => [0 => 'po'], 'translation.loader.mo' => [0 => 'mo'], 'translation.loader.qt' => [0 => 'ts'], 'translation.loader.csv' => [0 => 'csv'], 'translation.loader.res' => [0 => 'res'], 'translation.loader.dat' => [0 => 'dat'], 'translation.loader.ini' => [0 => 'ini'], 'translation.loader.json' => [0 => 'json']], ['cache_dir' => ($this->targetDir.''.'/translations'), 'debug' => true, 'resource_files' => ['af' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.af.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.af.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.af.xlf'], 'ar' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.ar.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.ar.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.ar.xlf'], 'az' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.az.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.az.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.az.xlf'], 'be' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.be.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.be.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.be.xlf'], 'bg' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.bg.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.bg.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.bg.xlf'], 'bs' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.bs.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.bs.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.bs.xlf'], 'ca' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.ca.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.ca.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.ca.xlf'], 'cs' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.cs.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.cs.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.cs.xlf'], 'cy' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.cy.xlf'], 'da' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.da.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.da.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.da.xlf'], 'de' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.de.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.de.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.de.xlf'], 'el' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.el.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.el.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.el.xlf'], 'en' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.en.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.en.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.en.xlf'], 'es' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.es.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.es.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.es.xlf'], 'et' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.et.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.et.xlf'], 'eu' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.eu.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.eu.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.eu.xlf'], 'fa' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.fa.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.fa.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.fa.xlf'], 'fi' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.fi.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.fi.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.fi.xlf'], 'fr' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.fr.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.fr.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.fr.xlf'], 'gl' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.gl.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.gl.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.gl.xlf'], 'he' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.he.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.he.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.he.xlf'], 'hr' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.hr.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.hr.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.hr.xlf'], 'hu' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.hu.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.hu.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.hu.xlf'], 'hy' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.hy.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.hy.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.hy.xlf'], 'id' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.id.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.id.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.id.xlf'], 'it' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.it.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.it.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.it.xlf'], 'ja' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.ja.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.ja.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.ja.xlf'], 'lb' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.lb.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.lb.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.lb.xlf'], 'lt' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.lt.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.lt.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.lt.xlf'], 'lv' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.lv.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.lv.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.lv.xlf'], 'mn' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.mn.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.mn.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.mn.xlf'], 'nb' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.nb.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.nb.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.nb.xlf'], 'nl' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.nl.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.nl.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.nl.xlf'], 'nn' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.nn.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.nn.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.nn.xlf'], 'no' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.no.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.no.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.no.xlf'], 'pl' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.pl.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.pl.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.pl.xlf'], 'pt' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.pt.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.pt.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.pt.xlf'], 'pt_BR' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.pt_BR.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.pt_BR.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.pt_BR.xlf'], 'ro' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.ro.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.ro.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.ro.xlf'], 'ru' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.ru.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.ru.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.ru.xlf'], 'sk' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.sk.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.sk.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.sk.xlf'], 'sl' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.sl.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.sl.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.sl.xlf'], 'sq' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.sq.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.sq.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.sq.xlf'], 'sr_Cyrl' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.sr_Cyrl.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.sr_Cyrl.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.sr_Cyrl.xlf'], 'sr_Latn' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.sr_Latn.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.sr_Latn.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.sr_Latn.xlf'], 'sv' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.sv.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.sv.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.sv.xlf'], 'th' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.th.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.th.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.th.xlf'], 'tl' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.tl.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.tl.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.tl.xlf'], 'tr' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.tr.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.tr.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.tr.xlf'], 'uk' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.uk.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.uk.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.uk.xlf'], 'uz' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.uz.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.uz.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.uz.xlf'], 'vi' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.vi.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.vi.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.vi.xlf'], 'zh_CN' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.zh_CN.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.zh_CN.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.zh_CN.xlf'], 'zh_TW' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations\\validators.zh_TW.xlf', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations\\validators.zh_TW.xlf', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations\\security.zh_TW.xlf']], 'scanned_directories' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations', 3 => 'E:\\cabinet/translations', 4 => 'E:\\cabinet\\vendor\\symfony\\framework-bundle/translations', 5 => 'E:\\cabinet\\vendor\\sensio\\framework-extra-bundle\\src/translations', 6 => 'E:\\cabinet\\vendor\\symfony\\twig-bundle/translations', 7 => 'E:\\cabinet\\vendor\\symfony\\web-profiler-bundle/translations', 8 => 'E:\\cabinet\\vendor\\symfony\\monolog-bundle/translations', 9 => 'E:\\cabinet\\vendor\\symfony\\debug-bundle/translations', 10 => 'E:\\cabinet\\vendor\\symfony\\maker-bundle\\src/translations', 11 => 'E:\\cabinet\\vendor\\doctrine\\doctrine-bundle/translations', 12 => 'E:\\cabinet\\vendor\\doctrine\\doctrine-migrations-bundle/translations', 13 => 'E:\\cabinet\\vendor\\symfony\\security-bundle/translations', 14 => 'E:\\cabinet\\vendor\\twig\\extra-bundle/translations', 15 => 'E:\\cabinet\\vendor\\nelmio\\cors-bundle/translations', 16 => 'E:\\cabinet\\vendor\\api-platform\\core\\src\\Bridge\\Symfony\\Bundle/translations'], 'cache_vary' => ['scanned_directories' => [0 => 'E:\\cabinet\\vendor\\symfony\\validator/Resources/translations', 1 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/translations', 2 => 'E:\\cabinet\\vendor\\symfony\\security-core/Resources/translations', 3 => 'translations', 4 => 'E:\\cabinet\\vendor\\symfony\\framework-bundle/translations', 5 => 'E:\\cabinet\\vendor\\sensio\\framework-extra-bundle\\src/translations', 6 => 'E:\\cabinet\\vendor\\symfony\\twig-bundle/translations', 7 => 'E:\\cabinet\\vendor\\symfony\\web-profiler-bundle/translations', 8 => 'E:\\cabinet\\vendor\\symfony\\monolog-bundle/translations', 9 => 'E:\\cabinet\\vendor\\symfony\\debug-bundle/translations', 10 => 'E:\\cabinet\\vendor\\symfony\\maker-bundle\\src/translations', 11 => 'E:\\cabinet\\vendor\\doctrine\\doctrine-bundle/translations', 12 => 'E:\\cabinet\\vendor\\doctrine\\doctrine-migrations-bundle/translations', 13 => 'E:\\cabinet\\vendor\\symfony\\security-bundle/translations', 14 => 'E:\\cabinet\\vendor\\twig\\extra-bundle/translations', 15 => 'E:\\cabinet\\vendor\\nelmio\\cors-bundle/translations', 16 => 'E:\\cabinet\\vendor\\api-platform\\core\\src\\Bridge\\Symfony\\Bundle/translations']]], []);
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings([0 => 'E:\\cabinet\\vendor\\symfony\\form/Resources/config/validation.xml']);
    ...
    {
        return $this->privates['var_dumper.server_connection'] = new \Symfony\Component\VarDumper\Server\Connection('tcp://'.$this->getEnv('string:VAR_DUMPER_SERVER'), ['source' => new \Symfony\Component\VarDumper\Dumper\ContextProvider\SourceContextProvider('UTF-8', 'E:\\cabinet', ($this->privates['debug.file_link_formatter'] ?? $this->getDebug_FileLinkFormatterService())), 'request' => new \Symfony\Component\VarDumper\Dumper\ContextProvider\RequestContextProvider(($this->services['request_stack'] ?? ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack()))), 'cli' => new \Symfony\Component\VarDumper\Dumper\ContextProvider\CliContextProvider()]);
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles_metadata' => [
                'FrameworkBundle' => [
                    'path' => 'E:\\cabinet\\vendor\\symfony\\framework-bundle',
                    'namespace' => 'Symfony\\Bundle\\FrameworkBundle',
                ],
                'SensioFrameworkExtraBundle' => [
                    'path' => 'E:\\cabinet\\vendor\\sensio\\framework-extra-bundle\\src',
                    'namespace' => 'Sensio\\Bundle\\FrameworkExtraBundle',
                ],
                'TwigBundle' => [
                    'path' => 'E:\\cabinet\\vendor\\symfony\\twig-bundle',
                    'namespace' => 'Symfony\\Bundle\\TwigBundle',
                ],
                'WebProfilerBundle' => [
                    'path' => 'E:\\cabinet\\vendor\\symfony\\web-profiler-bundle',
                    'namespace' => 'Symfony\\Bundle\\WebProfilerBundle',
                ],
                'MonologBundle' => [
                    'path' => 'E:\\cabinet\\vendor\\symfony\\monolog-bundle',
                    'namespace' => 'Symfony\\Bundle\\MonologBundle',
                ],
                'DebugBundle' => [
                    'path' => 'E:\\cabinet\\vendor\\symfony\\debug-bundle',
                    'namespace' => 'Symfony\\Bundle\\DebugBundle',
                ],
                'MakerBundle' => [
                    'path' => 'E:\\cabinet\\vendor\\symfony\\maker-bundle\\src',
                    'namespace' => 'Symfony\\Bundle\\MakerBundle',
                ],
                'DoctrineBundle' => [
                    'path' => 'E:\\cabinet\\vendor\\doctrine\\doctrine-bundle',
                    'namespace' => 'Doctrine\\Bundle\\DoctrineBundle',
                ],
                'DoctrineMigrationsBundle' => [
                    'path' => 'E:\\cabinet\\vendor\\doctrine\\doctrine-migrations-bundle',
                    'namespace' => 'Doctrine\\Bundle\\MigrationsBundle',
                ],
                'SecurityBundle' => [
                    'path' => 'E:\\cabinet\\vendor\\symfony\\security-bundle',
                    'namespace' => 'Symfony\\Bundle\\SecurityBundle',
                ],
                'TwigExtraBundle' => [
                    'path' => 'E:\\cabinet\\vendor\\twig\\extra-bundle',
                    'namespace' => 'Twig\\Extra\\TwigExtraBundle',
                ],
                'NelmioCorsBundle' => [
                    'path' => 'E:\\cabinet\\vendor\\nelmio\\cors-bundle',
                    'namespace' => 'Nelmio\\CorsBundle',
                ],
                'ApiPlatformBundle' => [
                    'path' => 'E:\\cabinet\\vendor\\api-platform\\core\\src\\Bridge\\Symfony\\Bundle',
            ...
            'translator.default_path' => 'E:\\cabinet/translations',
            ...
            'twig.default_path' => 'E:\\cabinet/templates',
