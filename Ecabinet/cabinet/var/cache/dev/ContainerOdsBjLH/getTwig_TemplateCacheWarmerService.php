...
class getTwig_TemplateCacheWarmerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        return $container->privates['twig.template_cache_warmer'] = new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheWarmer((new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            ...
            'twig' => '?',
        ]))->withContext('twig.template_cache_warmer', $container), new \Symfony\Bundle\TwigBundle\TemplateIterator(($container->services['kernel'] ?? $container->get('kernel', 1)), ['E:\\cabinet\\vendor\\symfony\\twig-bridge/Resources/views/Email' => 'email', 'E:\\cabinet\\vendor\\symfony\\twig-bridge/Resources/views/Form' => NULL], 'E:\\cabinet/templates'));
    }
}
