 ...
 */
final class Version20210331172607 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE coach (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, speciality VARCHAR(255) NOT NULL, salary DOUBLE PRECISION NOT NULL, age INT DEFAULT NULL, poid INT DEFAULT NULL, hauteur INT DEFAULT NULL, facebook VARCHAR(255) DEFAULT NULL, insta VARCHAR(255) DEFAULT NULL, gmail VARCHAR(255) DEFAULT NULL, bio VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_3F596DCCA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE likes (post_id INT NOT NULL, users_id INT NOT NULL, INDEX IDX_49CA4E7D4B89032C (post_id), INDEX IDX_49CA4E7D67B3B43D (users_id), PRIMARY KEY(post_id, users_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE dislikes (post_id INT NOT NULL, users_id INT NOT NULL, INDEX IDX_2DF3BE114B89032C (post_id), INDEX IDX_2DF3BE1167B3B43D (users_id), PRIMARY KEY(post_id, users_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE dislikes DROP FOREIGN KEY FK_2DF3BE1167B3B43D');
