...
import com.scheidtbachmann.phfa.digitalproduct.zrconnector.model.BookingDataDTO;
...
@Validated
@Api(value = "bookingTransactions", description = "the bookingTransactions API")
public interface BookingTransactionsApi {
    ...
    /**
     * PUT /bookingTransactions : booking of the transaction
     *
     * @param xSampBSelfCheckoutApp  (required)
     * @param bookingDataDTO  (required)
     ...
     */
    @ApiOperation(value = "booking of the transaction", nickname = "bookingTransactionsPUT", notes = "", response = ResponseCodeDTO.class, tags={ "BookingTransactions", })
    @ApiResponses(value = { 
    ...
    @RequestMapping(
        ...
        value = "/bookingTransactions",
        produces = { "application/json" },
        consumes = { "application/json" }
    )
    default ResponseEntity<ResponseCodeDTO> bookingTransactionsPUT(@ApiParam(value = "", required = true, defaultValue = "SampB-SelfCheckout-2022") @RequestHeader(value = "X-SampB-SelfCheckout-App", required = true) String xSampBSelfCheckoutApp,@ApiParam(value = "", required = true) @Valid @RequestBody BookingDataDTO bookingDataDTO,@ApiParam(value = "") @RequestHeader(value = "correlationId", required = false) String correlationId) {
