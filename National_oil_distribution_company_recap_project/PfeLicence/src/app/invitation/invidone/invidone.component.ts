...
@Component({
  selector: 'app-invidone',
  templateUrl: './invidone.component.html',
  styleUrls: ['./invidone.component.scss']
})
export class InvidoneComponent implements OnInit {
  ...
  getData() {
    ...
    this.crudApi.getDone().subscribe(
